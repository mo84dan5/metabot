import { MicButton } from './uiComponents.js';

export function createMicButton() {
  const micButton = new MicButton();
  micButton.appendTo(document.body);
  return micButton.element;
}

export function createMicButtonLegacy() {
